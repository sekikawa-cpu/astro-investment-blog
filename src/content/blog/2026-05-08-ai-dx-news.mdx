...
今週から来週にかけて、GoogleのI/O（5/19）に向けた情報が出始める時期です。Gemini 4.0の発表が予想されており、AIモデル競争の次のラウンドが始まろうとしています。GitHub Copilotの従量課金化の話は、社内の開発者文化にも影響する話題なので、チームに早めに情報共有しておこうと思っています。コスト意識を持たずにAIツールを使い続けると、後で予算面の議論になりかねないので。
